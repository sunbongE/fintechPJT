...
CREATE TABLE `group_notification` (
  ...
  `type` enum('INVITE','TYPE_B','TYPE_C') DEFAULT NULL,
  `group_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`group_notification_id`),
  KEY `FKc44vppy3s8eu9bt42l7iqgl5s` (`group_id`),
  CONSTRAINT `FKc44vppy3s8eu9bt42l7iqgl5s` FOREIGN KEY (`group_id`) REFERENCES `trip_group` (`group_id`)
