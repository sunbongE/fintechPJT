...
public class GroupController {
    ...
    public ResponseEntity<?> firstcall(@PathVariable("groupId") int groupId, Principal principal) {
        String memberId = principal.getName();
    ...
    @Operation(summary = "그룹에서 정산 하기를 누른 사람 목록", description = "그룹에서 정산 하기를 누른 사람 목록을 확인할 수 있다.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "성공"),
        @ApiResponse(responseCode = "500", description = "서버 오류")
    })
    ...
    @Operation(summary = "최종 정산 내역 확인", description = "최종 정산 내역 확인을 확인할 수 있다.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "성공"),
        @ApiResponse(responseCode = "500", description = "서버 오류")
    })
    ...
    @Operation(summary = "그룹에서 회원의 상태조회", description = "BEFORE, SPLIT, DOING, DONE")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "성공"),
        @ApiResponse(responseCode = "500", description = "서버 오류")
    })
